...
public class DemoApplicationContextAnnotations {
    ...
    public static void main(String[] args) {
        ...
        Product varianProduct = context.getBean("variantProduct", Product.class);
        Product masterProduct = context.getBean("masterProduct",  Product.class);
        System.out.println(varianProduct.getClass().getName());
        ...
        System.out.println("Master Product is injected into special offer object " + specialOffer);
        System.out.println("Variant Product is injected into special offer object " + specialOffer);
    }
}
